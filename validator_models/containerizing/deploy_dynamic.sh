...
start_container() {
    ...
    docker run -d \
      ...
      -e RESEARCH_LAB_VALIDATOR_FETCH_ENABLED="${RESEARCH_LAB_VALIDATOR_FETCH_ENABLED:-}" \
      -e RESEARCH_LAB_VALIDATOR_SHADOW_VERIFY_ENABLED="${RESEARCH_LAB_VALIDATOR_SHADOW_VERIFY_ENABLED:-}" \
      -e RESEARCH_LAB_VALIDATOR_EVALUATION_VERIFY_ENABLED="${RESEARCH_LAB_VALIDATOR_EVALUATION_VERIFY_ENABLED:-}" \
      -e RESEARCH_LAB_REQUIRE_SHADOW_VERIFICATION_BEFORE_SUBMIT="${RESEARCH_LAB_REQUIRE_SHADOW_VERIFICATION_BEFORE_SUBMIT:-}" \
      -e RESEARCH_LAB_REQUIRE_EVALUATION_VERIFICATION_BEFORE_SUBMIT="${RESEARCH_LAB_REQUIRE_EVALUATION_VERIFICATION_BEFORE_SUBMIT:-}" \
      -e RESEARCH_LAB_REIMBURSEMENTS_ENABLED="${RESEARCH_LAB_REIMBURSEMENTS_ENABLED:-}" \
      -e RESEARCH_LAB_WEIGHT_MUTATION_ENABLED="${RESEARCH_LAB_WEIGHT_MUTATION_ENABLED:-}" \
      -e RESEARCH_LAB_SUBMIT_ON_CHAIN_ENABLED="${RESEARCH_LAB_SUBMIT_ON_CHAIN_ENABLED:-}" \
