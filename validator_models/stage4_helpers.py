...
LOCATION_PATTERNS = [
    ...
    (84, re.compile(r'(Dubai(?:,\s*Dubai)?,?\s*(?:United Arab Emirates|UAE)?)', re.IGNORECASE)),
    (84, re.compile(r'(Abu\s+Dhabi(?:,\s*Abu\s+Dhabi)?,?\s*(?:United Arab Emirates|UAE)?)', re.IGNORECASE)),
