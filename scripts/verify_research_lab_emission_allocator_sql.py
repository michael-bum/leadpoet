#!/usr/bin/env python3
"""Static checks for Research Lab emission allocator SQL."""
...
MIGRATION = ROOT / "scripts" / "35-research-lab-emission-allocator.sql"
...
def main() -> int:
    ...
    if errors:
        ...
        return 1
    print(
        "Research Lab emission allocator SQL verified: champion rewards, "
        "allocation snapshots, current views, service-role RLS, append-only triggers."
    )
    return 0
